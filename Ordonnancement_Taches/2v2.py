# Programme théorique pour le critère 2 du sujet d'ordonnancement de tâches. Pas bien terminé mais exploitable donc à perfectionner pour quelque chose de correct et fonctionnel.
